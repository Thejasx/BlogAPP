...
const CommentTableItem = ({comment,fetchcomments}) => {
    ...
    const {blog ,creatadAt, _id} = comment
    const BlogDate = new Date(creatadAt)
  ...
  return (
    <tr className='order-y border-gray-300'>
        <td className='px-6 py-4'>
            ...
            <b className='font-medium text-gray-600'>Name</b> : {comment.name} <br /> <br />
        ...
        <td className='px-6 py-4 '>
            <div className='inline-flex items-center gap-4'>
                {!comment.isApproved ? <img src={assets.tick_icon} alt=""  className='w-5 hover:scale-110 transition-all cursor-pointer'/> : 
